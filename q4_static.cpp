//Static class Member(data & function), ⁠Static Object

//static data member - must declare inside class ,initialization and declaration outside class.
//static object -
#include <iostream>
#include <iomanip>
#include <vector>
...
protected:
    ...
    string name;
    double price;
    static int count; //static data member, declaration only.
...
int Item::count = 0; //definition outside the class
