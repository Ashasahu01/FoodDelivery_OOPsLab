//Constructor, parameterised constructor, default constructor

//constructor - Auto call when object is created, used for obj initialization. same name as class.Always created as public
//parameterized constructor - tells us the type of the we want from user. for ex - for price it can be float val, and for item it is string . 
//default constructor - if user not pass any value to the parameters then default value will be assign there by default.
...
public:
    Item(int i = 0, string n = "None", double p = 0.0) {//parameterized constructor with default value (default constructor)
        if(i <= 0)
...
public:
    FoodItem(int i, string n, double p, Category t) //parameterized constructor, tells us which type of data we require
        : Item(i, n, p), type(t) {}
...
public:
    DrinkItem(int i, string n, double p) : Item(i, n, p) {}//parameterized constructor
