// dynamic Allocation --> Allocates memory at runtime (in Heap Memomory)
// "new" keyword is using for dynamic allocation in C++(to get memory in heap)
...
int main() {
    vector<Item*> menu;      // Dynamic memory allocating
    vector<CartItem> cart;   // Cart item will store in Stack memory
