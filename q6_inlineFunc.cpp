//Inline Functon- when function is called it replace with the function code.func inside class auto treated as inline
...
public:
    ...
    virtual void display() { //inline function
        cout << "ID: " << id << " | " << name
             << " | Price: ₹" << fixed << setprecision(2) << price << endl;
    }

    double getPrice() { return price; } //inline func
    int getId() { return id; } //inline func
    string getName() { return name; } //inline func
