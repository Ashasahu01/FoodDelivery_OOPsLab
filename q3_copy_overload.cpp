//3. a) Overloaded constructor b) Copy Constructor

//constructor overloading - same name of constructor will be there but there parameters or datatype can be different(overloading).
//copy constructor - used for copying object. copy properties of one object to another.
//we are not using copy const in our code as we are storing pointers not objects. if we created any copy constructor it won't call here. because const is used when we pass obj by val or ret obj by value.
#include <iostream>
#include <iomanip>
#include <vector>
using namespace std;
...
public:
    Item(int i = 0, string n = "None", double p = 0.0) {  //constructor overloading
        if(i <= 0)
...
public:
    FoodItem(int i, string n, double p, Category t) //const overload
        : Item(i, n, p), type(t) {}
...
public:
    DrinkItem(int i, string n, double p) : Item(i, n, p) {} //const overload
