//Call by referenece, Return by reference

//call by ref - copy is modify original remains same.
//return by reference is not used in our project, as if we use it it modifies our original data which is risky.
...
public:
    ...
    double operator+(Item &obj) { //call by reference
        return this->price + obj.price;
    }

    bool operator==(Item &obj) { //call by reference
        return this->price == obj.price;
    }
    ...
    double getPrice() { return price; } //if we use ret by ref we use it here. 
    int getId() { return id; }
