 ...
 //unary -> applied on single operand
 //binary -> work over more than two operands
...
public:
    ...
    double operator+(Item &obj) {           // Binary Operator (for two operands)
        return this->price + obj.price;     // Here + operator is used to add price of objects
    }

    bool operator==(Item &obj) {           // Unary Operator 
        return this->price == obj.price;   // Here , if two itme are same then there price become same
    }
