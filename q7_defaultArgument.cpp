//Default argument using function - if user not pass any value to the parameters then default value will be assign there by default.
...
public:
    Item(int i = 0, string n = "None", double p = 0.0) { //default arguments
        if(i <= 0)
...
int main() {
    ...
    try {
        // Create Menu
        menu.push_back(new FoodItem(1, "Pizza", 200, VEG)); //if not passing any of argument here then default values will assign at that place.
