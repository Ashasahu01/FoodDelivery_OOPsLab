...
// Friend function allow operator overloading outside the class while accessing private data
...
public:
    ...
    friend void applyDiscount(Item &obj);        // Using friend function, outside function can access the private member which are inside the class. 
