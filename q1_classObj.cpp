...
//Access Specifier - with the help of this we can access data member and member function of the class 
    //private - data & mem access inside class only
    //protected - data n mem accessible inside class and in derived (child) class
...
//Item Class , blueprint for all the item which be created
class Item {
...
//FoodItem class inherit from the item class, blueprint for fooditems only, with the help of this we can categarise veg and nonVeg order
class FoodItem : public Item { //we can accesss all the data and methods of item class in derived class 
    Category type;
...
//drinkItem class also inehit from item class, with the help of this we can categaries drink item's order
class DrinkItem : public Item { //we can accesss all the data and methods of item class in derived class 
public:
